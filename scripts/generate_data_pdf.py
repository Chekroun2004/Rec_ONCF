...
def build_pdf():
    ...
    pdf.set_x(20)
    pdf.cell(12, 5, "")
    pdf.set_fill_color(*YELLOW_SOFT)
    pdf.rect(32, pdf.get_y(), 8, 5, "F")
    pdf.set_x(42)
    pdf.cell(20, 5, "META")
    pdf.set_fill_color(*RED_SOFT)
    pdf.rect(62, pdf.get_y() - 5, 8, 5, "F")
    pdf.set_x(72)
    pdf.cell(20, 5, "CIBLE")
    pdf.set_fill_color(*BLUE_SOFT)
    pdf.rect(92, pdf.get_y() - 5, 8, 5, "F")
    pdf.set_x(102)
    pdf.cell(25, 5, "CAT = categorielle")
    pdf.set_fill_color(*LIGHT_GREEN)
    pdf.rect(127, pdf.get_y() - 5, 8, 5, "F")
    pdf.set_x(137)
    pdf.cell(30, 5, "NUM = numerique")
    pdf.set_text_color(0, 0, 0)
    pdf.ln(8)
